...
var HandleRestricoesController = /** @class */ (function () {
    ...
    HandleRestricoesController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, siape, dia, letra, handleRestricoesService, createdRestricoes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, siape = _a.siape, dia = _a.dia, letra = _a.letra;
                    ...
                    case 1:
                        createdRestricoes = _b.sent();
                        return [2 /*return*/, response.status(201).json(createdRestricoes)];
                }
            });
        });
    };
    HandleRestricoesController.prototype.read = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var handleRestricoesService, listRestricoes;
    ...
    HandleRestricoesController.prototype.delete = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, siape, dia, letra, handleRestricoesService;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, siape = _a.siape, dia = _a.dia, letra = _a.letra;
                        handleRestricoesService = tsyringe_1.container.resolve(HandleRestricoesService_1.HandleRestricoesService);
                        return [4 /*yield*/, handleRestricoesService.delete(siape, dia, letra)];
                    case 1:
                        _b.sent();
